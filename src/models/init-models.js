...
// import _CategoryImages from "./categoryImage.js";
...
export default function initModels(sequelize) {
  ...
  // var CategoryImages = _CategoryImages.init(sequelize, DataTypes);
  ...
  // Category.hasOne(CategoryImages, { as: 'categoryImages', foreignKey: 'categoryId' });
  // CategoryImages.belongsTo(Category, { as: 'category', foreignKey: 'categoryId' });
